...
import { FaIndent, FaRegImage } from "react-icons/fa";
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-4 ">
        <div className="flex items-end gap-2">
          <div className=" pb-2">
            <Link href="/">
              <img
                src={`/images/logo/logo_head_white.svg`}
                contextMenu="false"
                alt="logo "
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-1 lg:px-6">
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/gallery" || pathname.includes("gallery")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/careers" || pathname.includes("careers")
                }
              >
                {(handleClick, open) => {
                  return (
